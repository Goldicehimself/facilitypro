          ...
          >
            ...
            <div className="mt-3 grid grid-cols-2 gap-2 text-xs text-zinc-600 dark:text-zinc-400">
              <div className="flex items-center gap-1">
                <span className={`font-semibold ${getRatingColor(vendor.rating)}`}>{vendor.rating}</span>
                <Star className="h-3.5 w-3.5 text-amber-500" />
              </div>
              <div>
                <span className="font-semibold text-zinc-500 dark:text-zinc-300">Last Service:</span>{' '}
                {vendor.lastService}
              </div>
            </div>
          </div>
